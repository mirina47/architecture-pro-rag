...
Бот верно ответил на вопросы, которые входят в его базу знаний. На остальные вопросы он ответил "I don't know", учитывая искусственные пробелы (ранее ответы по этим темам находились). 
...
Чтобы улучшить бот, необходимо продолжить обучение, а также увеличить базу знаний. Дополнительно можно заменить модель на более мощную.

[Логи запросов](Task7/logs.jsonl)

[Ожидаемые ответы](Task7/golden_questions.txt)

[Скрипт с проверкой качества](Task7/evaluate.py)

[Диаграмма последовательности](Task7/sequence_diagram.puml)